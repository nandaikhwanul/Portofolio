...
const Footer = () => {
  return (
    <div className="flex items-start w-full min-h-0 bg-white">
        ...
        <div
            ...
            <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                ...
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav className="mb-10 list-none">
                        <li className="mt-3">
                            <a className="text-gray-500 cursor-pointer hover:text-gray-900" ><Link to="contact" smooth={true} duration={500}>Contact Support</Link></a>
                        </li>
                        <li className="mt-3">
                            <a className="text-gray-500 cursor-pointer hover:text-gray-900">Help Resources</a>
                        </li>
                        <li className="mt-3">
                            <a className="text-gray-500 cursor-pointer hover:text-gray-900">Updates Info</a>
                        </li>
                    </nav>
                </div>
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav className="mb-10 list-none">
                        ...
                        <li className="mt-3">
                            <a className="text-gray-500 cursor-pointer hover:text-gray-900 text-sm">+62 8956-1816-5985</a>
                        </li>
                    </nav>
                </div>
            </div>
        </div>
        <div classNameName="bg-gray-300">
            <div classNameName="container px-5 py-4 mx-auto">
                <p classNameName="text-sm text-gray-700 capitalize xl:text-center">© 2023 All rights reserved </p>
            </div>
        </div>
    </footer>
